...
class LoginForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.fields['user'].widget = forms.PasswordInput(attrs={'class': 'form-control'})
...
class BaseSignupForm(_base_signup_form_class()):
    username = forms.CharField(label=_("Username"),min_length=app_settings.USERNAME_MIN_LENGTH,
...
class SignupForm(BaseSignupForm):
    ...
    password1 = PasswordField(label=_("Password"),widget = forms.TextInput(attrs={'class': 'fg-line'}))
    password2 = PasswordField(label=_("Confirm Password"),widget=forms.PasswordInput(
                               attrs={'class': "fg-line",'autofocus': 'autofocus'}))
    # password1 = forms.PasswordField(label=_("Username"),
    #                            min_length=app_settings.USERNAME_MIN_LENGTH,
    #                            widget=forms.TextInput(
    #                            attrs={'class': "fg-line",'placeholder':
    #                                       _('Username'),
    #                                       'autofocus': 'autofocus'}))
    def __init__(self, *args, **kwargs):
...
class ChangePasswordForm(PasswordVerificationMixin, UserForm):
    ...
    oldpassword = PasswordField(label=_("Current Password"),widget = forms.TextInput(attrs={'class': 'fg-line'}))
    password1 = SetPasswordField(label=_("New Password"),widget = forms.TextInput(attrs={'class': 'fg-line'}))
    password2 = PasswordField(label=_("New Password (again)"),widget = forms.TextInput(attrs={'class': 'fg-line'}))

    def __init__(self, *args, **kwargs):
        super(ChangePasswordForm, self).__init__(*args, **kwargs)
        self.fields['oldpassword'].widget = forms.PasswordInput(attrs={'class': 'form-control','placeholder':
...
class ResetPasswordKeyForm(PasswordVerificationMixin, forms.Form):
    ...
    password1 = SetPasswordField(label=_("New Password"),widget = forms.PasswordInput(attrs={'class': 'fg-line'}))
