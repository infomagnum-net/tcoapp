...
class Plan(models.Model):
    ...
    instance_price=models.CharField(max_length=4,blank=True)
    rds_price=models.CharField(max_length=4,blank=True)
    s3_price=models.CharField(max_length=4,blank=True)
    balancer_price=models.CharField(max_length=4,blank=True)
    ...
    def _get_amount(self):
        ...
        #return self.instance_count +self.rds_count + self.s3_count
        self.metered_features.aggregate(total=models.Sum('price_per_unit'))
        #return self.metered_features__price_per_unit + s3_metered_features__price_per_unit
        #self.metered_features.aggregate(total=models.Sum('price_per_unit'))['total']
    ...
    def _get_rds_cost(self):
        ...
        return (self.rds_count*rdsprice)
    ...
    def _get_loadbalancer_cost(self):
        ...
        return (self.balancer_count*balacer_price)
    ...
    def _get_total_plan_cost(self):
        ...
        return ((self.instance_count*instance_price)+
            ...
            +(self.balancer_count*balacer_price))
    ...
    def save(self):
        ...
        self.amount = (self.instance_count*instance_price)
        super(Plan, self).save()


    # product_price = models.CharField(
    #     max_length=200, help_text='Display name of the plan.',
    #     default=str(total_plan_price),
    #     blank=True
    )
