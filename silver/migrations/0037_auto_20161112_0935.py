...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('silver', '0036_auto_20161110_1026'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Origin', models.CharField(help_text=b'Origin', max_length=200, null=True, blank=True)),
                ...
                ('ContentType', models.CharField(help_text=b'Please enter From_Location', max_length=200, null=True, blank=True)),
                ('Recipient', models.CharField(help_text=b'Please enter From_Location_Type', max_length=200, null=True, blank=True)),
            ],
        ),
        migrations.AddField(
            model_name='s3storage',
            name='RelatedTo',
            field=models.CharField(help_text=b'Please enter RelatedTo', max_length=200, null=True, blank=True),
        ),
    ]
