materialAdmin
    ...
    .controller('materialadminCtrl', function($timeout, $state, $scope, growlService){
        //Welcome Message
        userinfo = $("#profileinfo").html().replace()
        userinfo = userinfo.replace(/\'/g, '\"');
        json_user_info = JSON.parse(userinfo);
        console.log(json_user_info)
        profile_name = $("#prfl-name p").html(json_user_info['name']);
        profile_designation = $("#prfl-name small").html(json_user_info['designation']);


        growlService.growl('Welcome back ' +json_user_info['name']+' !', 'inverse')
    ...
    .controller('profileCtrl', function(growlService){
        ...
        //User
        this.profileSummary = json_user_info['profileSumm'];
        this.fullName = json_user_info['name'];
        this.gender = json_user_info['gender'];
        this.birthDay = json_user_info['birthDay'];
        this.martialStatus = json_user_info['martialStatus'];
        this.mobileNumber = json_user_info['mobileNumber'];
        this.emailAddress = json_user_info['email'];
        this.twitter = json_user_info['twitter'];
        this.twitterUrl = json_user_info['twitterUrl'];
        this.skype = json_user_info['skype'];
        this.addressSuite = json_user_info['addressSuite'];
        this.addressCity = json_user_info['addCountry'];
        this.addressCountry = json_user_info['addCountry'];
        this.companyName = json_user_info['companyName'];
        this.designation = json_user_info['designation'];
        this.yearsofExperience = json_user_info['yearsofExp'];
        this.technologyInterests = json_user_info['techInterests'];
        this.alternativemobilephone = json_user_info['altmobilephone'];
        this.personalemial = json_user_info['persemial'];
        this.facebook =json_user_info['facebook'];
        this.linkedin = json_user_info['linkedin'];
        this.hotmail = json_user_info['hotmail'];
        this.githublink = json_user_info['gitlink'];
